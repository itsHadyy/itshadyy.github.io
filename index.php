                    ...
                    <div class="card card-l testimonials" id="testimonials">
                        ...
                        <div class="slideshow-container">
                            ...
                            <div class="mySlides fade">
                                <p>“I had the pleasure of working with Hady Korshem on a project called Haus, a user
                                    interface viewable at https://itshadyy.github.io/haus/ . Hady's
                                    expertise as a frontend developer was instrumental in bringing this project to life.

                                    Hady demonstrated a strong understanding of frontend development principles. His
                                    proficiency in HTML, CSS, and JavaScript was evident throughout the project. He was
                                    able to translate complex design concepts into clean and functional code.

                                    Hady was a fantastic communicator. He kept me informed of his progress and was
                                    always open to feedback. He was also a great collaborator, readily adapting to new
                                    ideas and working effectively with other team members.

                                    Hady's contributions were essential to the success of the Haus project. His
                                    technical skills, communication style, and collaborative spirit make him a valuable
                                    asset to any development team. I highly recommend Hady Korshem for any frontend
                                    development position.”</p>
                                <h3>Jessica Turner</h3>
                                <p>Head of Operations - Haus</p>
                            </div>

                            <div class="mySlides fade">
                                <p>“Hady Korshem was a fantastic frontend developer on the Gaia project.  He built a user-friendly interface that looked great and worked flawlessly. Hady's a coding whiz (HTML, CSS, JavaScript) and easily turned our ideas into reality. He communicated clearly and worked świetnie (greatly) as part of the team. I highly recommend Hady for any frontend development position.”</p>
                                <h3>Silvia Torrente</h3>
                                <p>Senior Project Mnager</p>
                            </div>
